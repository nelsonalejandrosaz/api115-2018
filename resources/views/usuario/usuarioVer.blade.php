    ...
    <div class="box box-default">
        ...
        <form class="form-horizontal">
            <div class="box-body">
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input readonly type="text" class="form-control" placeholder="ej. Juan" name="nombre" value="{{$usuario->nombre}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input readonly type="text" class="form-control" placeholder="ej. Quintanilla"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input readonly type="text" class="form-control" placeholder="ej. empleado@lgl.com" name="email" value="{{$usuario->email}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input readonly type="text" class="form-control" placeholder="ej. juanquintanilla" name="username" value="{{$usuario->username}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            <input readonly type="text" class="form-control" placeholder="ej. juanquintanilla" name="username" value="{{$usuario->rol->nombre}}">
                        </div>
                    </div>
                ...
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input readonly type="text" class="form-control" placeholder="(503) 9999-9999" name="telefono_1" value="{{$usuario->telefono}}">
                        </div>
                    </div>
            ...
            <div class="box-footer">
                ...
                <a href="{{ route('usuarioEditar', ['id' => $usuario->id]) }}" class="btn btn-lg btn-warning pull-right" id="enviar-buttom"><span class="fa fa-edit"></span> Editar</a>
            </div>
        </form>
    </div><!-- /.box -->
