...
@section('contentheader_title')
    Factura Comercial n° {{$venta->numero}}
@endsection
    ...
    <div class="box box-default">
        ...
        <form class="form-horizontal" action="{{ route('ventaNuevaPost', ['id' => $ordenPedido->id]) }}" method="POST">
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control puCls"
                                               ...
                                               name="preciosUnitarios[]" id="precioUnitario" value="{{number_format($salida->precioUnitario,2)}}" disabled>
                                    </div>
                                </td>
                                {{--Ventas exentas--}}
                                <td>
            ...
            <div class="box-footer">
                <a href="{{ route('ventaFacturaLista') }}" class="btn btn-lg btn-default">Regresar a lista</a>
                <a href="{{ route('facturaPDF',['id' => $venta->id]) }}" class="btn btn-lg btn-info pull-right">Imprimir factura</a>
            </div>
        </form>
    </div><!-- /.box -->
