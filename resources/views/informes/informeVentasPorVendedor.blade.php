            ...
            <div class="box-body">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            <select class="form-control select2" style="width: 100%" name="vendedor_id" id="clienteID">
                                <option value="" selected disabled>Seleciona un vendedor</option>
                                @foreach($vendedores as $vendedor)
                                    @if($vendedor->id == Request::input('vendedor_id'))
