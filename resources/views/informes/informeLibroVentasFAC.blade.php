        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <h2 class="page-header">
                    <i class="fa fa-globe"></i> LGL S.A. de C.V. -- Libro de ventas Facturas
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-striped table-condensed" id="tblProductos">
                        ...
                        <tr>
                            ...
                            <th style="width: 7%">N° de venta</th>
                            <th style="width: 7%">N° de registro</th>
                            <th style="width: 23%">Nombre cliente</th>
                            <th style="width: 7%">Propias exentas</th>
                            <th style="width: 7%">Propias gravadas</th>
                            <th style="width: 7%">Propias deb fiscal</th>
                            <th style="width: 7%">Terceros exentas</th>
                            <th style="width: 7%">Terceros gravadas</th>
                            <th style="width: 7%">Total Terceros deb fiscal</th>
                            <th style="width: 7%">IVA Retenido</th>
                        ...
                        <tbody>
                            @foreach($tabla as $fila)
                                <tr>
                                    ...
                                    <td>{{ $fila['N° DE VENTA'] }}</td>
                                    <td>{{ $fila['N° DE REGISTRO'] }}</td>
                                    <td>{{ $fila['NOMBRE DEL CLIENTE'] }}</td>
                                    <td>$ {{ $fila['PROPIAS EXENTAS'] }}</td>
                                    <td>$ {{ $fila['PROPIAS GRAVADAS'] }}</td>
                                    <td>$ {{ $fila['PROPIAS DEB FISCAL'] }}</td>
                                    <td>$ {{ $fila['TERCEROS EXENTAS'] }}</td>
                                    <td>$ {{ $fila['TERCEROS GRAVADAS'] }}</td>
                                    <td>$ {{ $fila['TERCEROS DEB FISCAL'] }}</td>
                                    <td>$ {{ $fila['IVA RETENIDO'] }}</td>
                                    <td>$ {{ $fila['TOTAL'] }}</td>
                                </tr>
                            @endforeach
                        </tbody>
