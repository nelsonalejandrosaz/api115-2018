...
<table class="tg">
    ...
    <tr>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b">{{$venta->orden_pedido->cliente->id}}</td>
        <td class="tg-cw2b"></td>
    ...
    <tr>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b">{{strtoupper($venta->orden_pedido->cliente->nombre)}}</td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
    ...
    <tr>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b" colspan="5">{{strtoupper($venta->orden_pedido->cliente->direccion)}}</td>
    ...
    <tr>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b">{{strtoupper($venta->orden_pedido->cliente->municipio->nombre)}}</td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
    ...
    @foreach($venta->orden_pedido->salidas as $salida)
        <tr>
            ...
            <td class="tg-cw2b">{{strtoupper($salida->unidad_medida->abreviatura)}}</td>
            <td class="tg-cw2b">{{$salida->cantidad_ums}}</td>
            <td class="tg-cw2b">$ {{number_format($salida->precio_unitario_ums,2)}}</td>
            <td class="tg-cw2b"></td>
            <td class="tg-cw2b"></td>
    ...
    <tr>
        ...
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b">$ {{number_format($venta->orden_pedido->ventas_gravadas,2)}}</td>
    </tr>
    <tr>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        ...
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b">$ {{number_format($venta->orden_pedido->porcentaje_IVA,2)}}</td>
    </tr>
    <tr>
        <td class="tg-cw2b"></td>
        <td class="tg-cw2b"></td>
