    ...
    <div class="box box-default">
        ...
        <form class="form-horizontal" action="{{ route('ajusteNuevoPost') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control" placeholder="0.00" name="valorUnitarioAnterior" id="valorUnitarioID" disabled>
                            </div>
                        </div>
                    </div>
                    {{-- Cantidad ajuste --}}
            ...
            <div class="box-footer">
                <a href="{{ route('ajusteLista') }}" class="btn btn-lg btn-default">Cancelar</a>
