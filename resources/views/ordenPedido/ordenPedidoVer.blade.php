    ...
    <div class="box box-primary">
        ...
        <form class="form-horizontal" action="{{ route('ordenPedidoNuevaPost') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            <input type="date" class="form-control" name="fechaIngreso"
                                   value="{{$ordenPedido->fechaIngreso}}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            <input type="date" class="form-control" name="fechaEntrega"
                                   value="{{$ordenPedido->fechaEntrega}}" disabled>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered" id="tblProductos">
                        ...
                        @foreach($ordenPedido->salidas as $salida)
                            <tr>
                                {{--Productos--}}
                                <td>
                                    <select class="form-control select2 selProd" name="productos_id[]"
                                ...
                                {{--Exenta--}}
                                <td align="center">
                                    <input type="checkbox" class="tipoVentaCls" id="tipoVenta" name="exentas[]" disabled>
                                </td>
                                <td align="center">
            ...
            <div class="box-footer">
                ...
                <a href="{{ route('ordenPedidoLista') }}" class="btn btn-lg btn-info pull-right">Imprimir Orden</a>
            </div>
        </form>
    </div><!-- /.box -->
