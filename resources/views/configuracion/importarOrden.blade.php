...
@section('htmlheader_title')
    Importar ordenes con saldos pendientes
@endsection
...
@section('contentheader_description')
    Importar ordenes con saldos pendientes a través de archivo
@endsection
...
@section('main-content')
    ...
    <div class="box box-default">
        ...
        <!-- form start -->
        <form class="form-horizontal" action="{{ route('importarOrdenesPost') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <p class="help-block">Suba en archivo llamado "ordenes-pendientes-lgl.xlsx".</p>
                    </div>
                </div>
            </div><!-- /.box-body -->
