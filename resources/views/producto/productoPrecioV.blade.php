                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered" id="tblProductos">
                        ...
                        <tr>
                            ...
                            <td>
                                <input readonly type="text" class="form-control" name="presentacion[]" value="{{$precio->presentacion}}">
                            </td>
                            <td>
                                <input readonly type="text" class="form-control" name="descripcion[]" placeholder="ej. Tarro de 250g" value="{{$precio->nombre_factura}}">
                            </td>
                            <td>
                                <select disabled style="width: 100%" class="form-control select2" name="unidad_medida_id[]">
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    @foreach($unidad_medidas as $unidad_medida)
                            ...
                            <td>
                                <div class="input-group">
                                    <span class="input-group-addon">$</span>
                                    <input readonly required type="number" min="0.00" step="any" class="form-control cantidadCls" name="precio[]"
                            ...
                            <td>
                                <input readonly required type="number" min="0.00" step="any" class="form-control factor" name="factor[]"
                                       value="{{$precio->factor}}">
                            </td>
                            <td align="center">
                                @if( Auth::user()->rol->nombre == 'Administrador')
